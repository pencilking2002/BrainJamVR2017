...
Shader "Custom/Scrolling/Color Texture Transparent 2 Crossfade Mask" {
Properties {	
...
//			fixed4 _Color2;
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				half lerpPercent = (_SinTime.z+1)/4+.25;
				
				fixed4 col = _Color*lerp(mainTex,mainTex2,lerpPercent);
