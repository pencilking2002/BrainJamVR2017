...
//					atten*=16;
			...
			{	
				...
				//textures
				fixed4 tex = tex2D(_MainTex,_MainTex_ST.xy*i.texcoord.xy + _MainTex_ST.zw*_Time.y);
				...
				half3 lightFinal=texFinal*(diffuseReflection+emissionFinal+i.col);
				
				fixed3 colorFinal=rimFinal+lightFinal;
				colorFinal*=directionValue;
